...
- Tabela: `basedosdados.br_bd_diretorios_brasil.municipio`
- Tipo de ingestão: Batch
- Chave principal: `id_municipio`
...
```text
data/bronze/batch/municipio/
```

Tabela no BigQuery:

```text
rising-reserve-352718.tc_alfabetizacao_bronze.municipio
```
